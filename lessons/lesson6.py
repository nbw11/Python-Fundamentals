...
# elif example
# Used when first condition is false and you want to try another
...
def nested_example(arg):
    if happy > arg:
        ...
        if happy > 30:
            print('happy is greater than 5')
        else:
            print('happy is less than 5')
...
# Basically a shorthand if statment
golf = 42
hotel = 24
